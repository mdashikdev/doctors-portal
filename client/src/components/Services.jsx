...
function Services() {
  return (
    <div className='lg:max-w-[1240px] w-10/12 mx-auto py-10'>
        <h4 className='text-center text-[#19D3AE] font-bold'>OUR SERVICES</h4>
        <h2 className='text-center text-2xl text-black/80 font-semibold'>Service We Provide</h2>

        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5 md:mt-10'>
            <div className='flex flex-col gap-2 items-center justify-center shadow rounded-xl p-3'>
                <img src={fluoride} className='w-24' alt="" />
                <h4 className='text-center text-2xl font-semibold'>Fluoride Treatment</h4>
                <p className='text-center text-black/70 px-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, saepe asperiores? Nemo qui, nobis fugit assumenda dolorem earum?</p>
            </div>
            <div className='flex flex-col gap-2 items-center justify-center shadow rounded-xl p-3'>
